...
public class VirgoServerCleanStartupPerformanceTests extends
	...
	@Test
	public void testServerCleanStartupPerformance() throws Exception {
		...
		for (int i = 0; i < NO_OF_ITERATIONS; i++) {
			...
			new Thread(new CleanStartUpThread()).start();
		...
		try {
			record("testServerCleanStartupPerformance", average, high, low, 26000); // last reported run of high: 24208 low: 21153 average: 22680 on mac pro desktop.
	...
	private static class CleanStartUpThread implements Runnable {
		public CleanStartUpThread() {
		}
